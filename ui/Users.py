...
class UsersManagement:
    def __init__(self, parent, users_db):
        ...
        message = """
🔹 تحكم أسرع في جدول المستخدمين:

• Ctrl + A → تحديد كل المستخدمين
• Ctrl + Shift + A → إزالة تحديد كل المستخدمين
• Home → الانتقال لأول مستخدم
• End → الانتقال لآخر مستخدم
• Insert → إضافة مستخدم جديد
• Delete → حذف المستخدم المحدد
• Enter أو ضغطة مزدوجة → فتح نافذة تعديل المستخدم
"""
        CTkButton(
            header,
            text="",
