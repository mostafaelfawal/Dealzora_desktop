...
• Ctrl + A → تحديد كل الفواتير
• Ctrl + Shift + A → إزالة تحديد كل الفواتير
• Home → الانتقال لأول فاتورة
• End → الانتقال لآخر فاتورة
• Enter أو ضغطة مزدوجة على الفاتورة → عرض تفاصيل الفاتورة
"""
        CTkButton(
            header,
            text="",
